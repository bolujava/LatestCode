...
///this is my addition
    ...
    const handleSearch = async (e) => {
      ...
      //     flightDetails.departurePort,
      //     flightDetails.arrivalPort,
      //     flightDetails.noOfAdult,
      //     flightDetails.noOfChildren,
      //     flightDetails.noOfInfant,
      ...
      // );
        ...
        //   noOfAdult: flightDetails.noOfAdult,
        //   noOfChildren: flightDetails.noOfChildren,
        //   noOfInfant: flightDetails.noOfInfant,
    ...
    return(
          ...
          <div className="backgroundd">
            ...
            <div className="booking-header">
          <button className="btnsty">
            <img src="src/Components/LandingPage/images/plane 1.png" alt="Flights" className="icon" /><span class="flight-text">Flights</span>
          </button>
          <button className="btnsty">
  <img src="src/Components/LandingPage/images/Vector.png" alt="Login" className="icon" />
  <span className="flight-text"> Log In</span>
</button>
