...
const ModalPageTrip = ({ isOpen, onClose, searchDetails }) => {
  
  if (!isOpen) return null;

  const { departurePort, arrivalPort, departureDate, returnDate } = searchDetails;
  return (
      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="departurespace">
            ...
            <h5>Booking Reference Number</h5>
              ...
              <div className="departure-info">
                ...
                <div className="oldArrivalSeparator" /> 
                <div className='departure-info-item'>
                  <h4>Arrival</h4>
                  {/* <h4>Lagos</h4> */}
                  <h4>{arrivalPort}</h4>
        ...
        <div className= "booking-payment">
            ...
            <Link to="/booking-confirmation">
              <button className="back-button-adult" type='submit'>Confirm Booking</button>
            </Link>
            <Link to="/make-payment">
              <button className="continue-button-adult" type='submit'>Continue to payment</button>
            </Link>
          </div>
        </div>
        </div>
